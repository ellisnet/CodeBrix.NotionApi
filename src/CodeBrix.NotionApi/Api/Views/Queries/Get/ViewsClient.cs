...
public sealed partial class ViewsClient
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            throw new ArgumentException("QueryId cannot be null or empty.", nameof(request));
        }
        ...
        {
            queryParams["page_size"] = request.PageSize.Value.ToString(CultureInfo.InvariantCulture);
        }
