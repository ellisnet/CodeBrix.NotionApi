...
public readonly struct RelativeDateValue : IEquatable<RelativeDateValue>
{
    ...
    public static implicit operator RelativeDateValue(DateTime value)
    {
        ...
        {
            formatted = value.ToString("yyyy-MM-ddTHH:mm:ssZ", CultureInfo.InvariantCulture);
        }
        else if (value.Kind == DateTimeKind.Local)
        {
            formatted = value.ToString("yyyy-MM-ddTHH:mm:sszzz", CultureInfo.InvariantCulture);
        }
        else
        {
            formatted = value.ToString("yyyy-MM-ddTHH:mm:ss", CultureInfo.InvariantCulture);
        }
    ...
    public static implicit operator RelativeDateValue(DateTimeOffset value) =>
        new RelativeDateValue(value.ToString("yyyy-MM-ddTHH:mm:sszzz", CultureInfo.InvariantCulture));
