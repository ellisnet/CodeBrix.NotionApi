...
public class RetryPolicyTests : ApiTestBase
{
    ...
    public async Task Retries_On_429_For_Get_Then_Succeeds()
    {
        ...
        var json = await File.ReadAllTextAsync("data/pages/PageObjectShouldHaveUrlPropertyResponse.json", cancellationToken: TestContext.Current.CancellationToken);
        ...
        var page = await client.Pages.RetrieveAsync(PageId, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task Retries_On_429_For_Post_Then_Succeeds()
    {
        ...
        var json = await File.ReadAllTextAsync("data/pages/CreatePageResponse.json", cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task Retries_On_503_For_Delete_Then_Succeeds()
    {
        ...
        await client.Blocks.DeleteAsync(BlockId, cancellationToken: TestContext.Current.CancellationToken); // no exception = success
