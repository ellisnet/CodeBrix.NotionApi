...
public class DataSourcesClientTests : IntegrationTestBase, IAsyncLifetime
{
    ...
    public async Task CreateDataSource_ShouldReturnSuccess()
    {
        ...
        // Act
        var response = await Client.DataSources.CreateAsync(request, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task UpdateDataSource_ShouldReturnSuccess()
    {
        ...
        var createResponse = await Client.DataSources.CreateAsync(createRequest, cancellationToken: TestContext.Current.CancellationToken);
        ...
        // Act
        var updateResponse = await Client.DataSources.UpdateAsync(updateRequest, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task QueryDataSourceAsync_ShouldReturnResults()
    {
        ...
        // Act
        var queryResponse = await Client.DataSources.QueryAsync(queryRequest, cancellationToken: TestContext.Current.CancellationToken);
