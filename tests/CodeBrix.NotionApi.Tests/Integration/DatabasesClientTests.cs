...
public class DatabasesClientTests : IntegrationTestBase, IAsyncLifetime
{
    ...
    public async Task Verify_mention_date_property_parsed_properly()
    {
        ...
        // Act
        var createdDatabase = await Client.Databases.CreateAsync(createDbRequest, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task UpdateDatabase()
    {
        ...
        // Act
        var updatedDatabase = await Client.Databases.UpdateAsync(updateRequest, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task RetrieveDatabase()
    {
        ...
        // Act
        var retrievedDatabase = await Client.Databases.RetrieveAsync(createdDatabase.Id, cancellationToken: TestContext.Current.CancellationToken);
