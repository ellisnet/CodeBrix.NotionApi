...
public class UpdatePropertyConfigurationRequestSerializationTests
{
    ...
    {
        // Serialize directly - this should now work with our converter factory
    ...
    [Fact]
    public void UpdatePropertyConfigurationRequestConverter_Read_Should_Throw_NotImplementedException()
    {
        // Arrange
        ...
        Assert.Throws<NotImplementedException>(() =>
        {
            ...
            reader.Read();
            converter.Read(ref reader, typeof(UpdatePropertyConfigurationRequest<TitleDataSourcePropertyConfigRequest>),
