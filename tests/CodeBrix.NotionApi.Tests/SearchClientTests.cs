...
public class SearchClientTests : ApiTestBase
{
    ...
    public async Task Search()
    {
        ...
        var jsonData = await File.ReadAllTextAsync("data/search/SearchResponse.json", cancellationToken: TestContext.Current.CancellationToken);
        ...
        // Act
        var searchResult = await _client.SearchAsync(searchParameters, cancellationToken: TestContext.Current.CancellationToken);
