...
public class BlocksClientTests : ApiTestBase
{
    ...
    public async Task RetrieveBlockChildren()
    {
        ...
        var jsonData = await File.ReadAllTextAsync("data/blocks/RetrieveBlockChildrenResponse.json", cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task AppendBlockChildren()
    {
        ...
        var jsonData = await File.ReadAllTextAsync("data/blocks/AppendBlockChildrenResponse.json", cancellationToken: TestContext.Current.CancellationToken);
        ...
        // Act
        var blocksResult = await _client.AppendChildrenAsync(request, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task RetrieveAsync()
    {
        ...
        var jsonData = await File.ReadAllTextAsync("data/blocks/RetrieveBlockResponse.json", cancellationToken: TestContext.Current.CancellationToken);
        ...
        var block = await _client.RetrieveAsync(blockId, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task UpdateAsync()
    {
        ...
        var jsonData = await File.ReadAllTextAsync("data/blocks/UpdateBlockResponse.json", cancellationToken: TestContext.Current.CancellationToken);
        ...
        var block = await _client.UpdateAsync(blockId, updateBlock, cancellationToken: TestContext.Current.CancellationToken);
