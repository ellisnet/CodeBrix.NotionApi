...
public class UserClientTests : ApiTestBase
{
    ...
    {
        // Arrange
        var jsonData = await File.ReadAllTextAsync("data/users/ListUsersResponse.json", cancellationToken: TestContext.Current.CancellationToken);
        ...
        // Act
        var users = await _client.ListAsync(cancellationToken: TestContext.Current.CancellationToken);
    ...
    {
        // Arrange
        var jsonData = await File.ReadAllTextAsync("data/users/RetrieveUserResponse.json", cancellationToken: TestContext.Current.CancellationToken);
        ...
        // Act
        var user = await _client.RetrieveAsync(userId, cancellationToken: TestContext.Current.CancellationToken);
    ...
    {
        // Arrange
        var jsonData = await File.ReadAllTextAsync("data/users/MeResponse.json", cancellationToken: TestContext.Current.CancellationToken);
        ...
        // Act
        var user = await _client.MeAsync(cancellationToken: TestContext.Current.CancellationToken);
    ...
    {
        // Arrange
        var jsonData = await File.ReadAllTextAsync("data/users/MeUserLevelResponse.json", cancellationToken: TestContext.Current.CancellationToken);
