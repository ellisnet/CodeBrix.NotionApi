...
public class PagesClientTests : ApiTestBase
{
    ...
    public async Task RetrieveAsync()
    {
        ...
        var jsonData = await File.ReadAllTextAsync("data/pages/PageObjectShouldHaveUrlPropertyResponse.json", cancellationToken: TestContext.Current.CancellationToken);
        ...
        var page = await _client.RetrieveAsync(pageId, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task CreateAsync()
    {
        ...
        var jsonData = await File.ReadAllTextAsync("data/pages/CreatePageResponse.json", cancellationToken: TestContext.Current.CancellationToken);
        ...
        var page = await _client.CreateAsync(pagesCreateParameters, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task UpdatePropertiesAsync()
    {
        ...
        var jsonData = await File.ReadAllTextAsync("data/pages/UpdatePagePropertiesResponse.json", cancellationToken: TestContext.Current.CancellationToken);
        ...
        var page = await _client.UpdatePropertiesAsync(pageId, updatedProperties, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task UpdatePageAsync()
    {
        ...
        var page = await _client.UpdateAsync(pageId, pagesUpdateParameters, cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task TrashPageAsync()
    {
        ...
        var jsonData = await File.ReadAllTextAsync("data/pages/TrashPageResponse.json", cancellationToken: TestContext.Current.CancellationToken);
