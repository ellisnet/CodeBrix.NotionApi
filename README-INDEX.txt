================================================================================
README-INDEX: CodeBrix.NotionApi
...
------------------------------------------------------------------
  AGENT-README.txt
      CodeBrix.NotionApi.MitLicenseForever — a .NET client library for the
      Notion API: every endpoint group, the full Notion object model, and
      authoring helpers, built on System.Text.Json.
